...
namespace Pcm.Api.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(AppDbContext context, IConfiguration configuration, NotificationService notificationService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Register([FromBody] RegisterRequest request)
        {
            ...
            var welcomeNoti = _notificationService.Create(
                member.Id,
                "Đăng ký thành công",
                "Chào mừng bạn đến với PCM. Bạn có thể nạp tiền, đặt sân và tham gia giải đấu ngay bây giờ.",
                "System"
            );
            await _context.SaveChangesAsync();
            await _notificationService.PushAsync(welcomeNoti);
        ...
        public async Task<IActionResult> Me()
        {
            ...
            return Ok(new
            {
                ...
                Rank = member.TotalSpent <= 0 ? 0 : Math.Round((double)(member.TotalSpent / 1_000_000m), 2)
            });
        }
