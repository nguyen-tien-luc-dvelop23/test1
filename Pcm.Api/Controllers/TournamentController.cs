...
namespace Pcm.Api.Controllers
{
    ...
    public class TournamentController : ControllerBase
    {
        ...
        public TournamentController(AppDbContext context, NotificationService notificationService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Join(int id, [FromBody] JoinTournamentRequest request)
        {
            ...
            try
            {
                ...
                var notification = _notificationService.Create(
                    ...
                    $"{tournament.Name} • Nhóm: {request.GroupName ?? "-"} • Số lượng: {request.TeamSize} • Phí: {tournament.EntryFee:N0}₫",
                    "Tournament"
                );
